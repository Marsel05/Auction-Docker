    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[django.core.validators.MinValueValidator(1970), django.core.validators.MaxValueValidator(2024)])),
                ...
                ('engine', models.CharField(choices=[('Бензин', 'Бензин'), ('Газ', 'Газ'), ('Дизель', 'Дизель')], max_length=16, verbose_name='Топливо')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='shop.car')),
            ],
        ),
        migrations.AddField(
            model_name='car',
            name='car_make',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.carmake'),
        ),
        migrations.AddField(
            model_name='carmake',
            name='category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_review', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.comment')),
            ],
        ),
        migrations.CreateModel(
            name='Model',
            fields=[
                ...
                ('car_make', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.carmake')),
            ],
        ),
        migrations.AddField(
            model_name='car',
